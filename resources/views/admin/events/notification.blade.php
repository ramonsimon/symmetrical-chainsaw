...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('cruds.event.Notifications') }} {{ trans('global.list') }}
        </div>
            ...
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-Event">
                    ...
                    @foreach($events as $key => $event)
                       @php
                        $formatted=Carbon\Carbon::parse($event->end_time);

                        $diffInDays = $formatted->diffInDays(Carbon\Carbon::now());
                        if ($diffInDays >= '20'){
                            $color = 'background-color: #2fa360';
                        ...
                        @endphp
                        <tr data-entry-id="{{ $event->end_time }}">
                            <td style="{{$color}} ">
                            ...
                            <td>
                                ...
                                {{  $event->name .', je kunt hier nog '. $diffInDays .' dagen over doen' }}
                            </td>
                            <td>
                                {{ $event->start_time ?? '' }}
                            </td>
